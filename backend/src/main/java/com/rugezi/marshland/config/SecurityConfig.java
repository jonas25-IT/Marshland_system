        ...
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth ->
                    auth.requestMatchers(org.springframework.http.HttpMethod.OPTIONS, "/**").permitAll()
                        ...
                        .requestMatchers("/api/booking/new").hasAnyRole("TOURIST", "ADMIN")
                        .requestMatchers("/api/booking/my-bookings").hasAnyRole("TOURIST", "ADMIN")
                        .requestMatchers("/api/booking/approve").hasAnyAuthority("ADMIN", "ROLE_ADMIN")
                        .requestMatchers("/api/booking/daily").hasAnyRole("ADMIN", "STAFF", "ECOLOGIST")
