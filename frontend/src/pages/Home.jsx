...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0D0E14] text-white font-sans overflow-x-hidden selection:bg-purple-500/30">
      ...
      {/* Navigation */}
      <nav className="relative z-50 flex justify-between items-center px-4 md:px-8 py-6 md:py-8 max-w-7xl mx-auto backdrop-blur-md sticky top-0 border-b border-white/5">
        ...
        <div className="flex items-center gap-4 md:gap-8 relative z-50">
           <a href="#features" className="text-xs md:text-sm font-medium text-gray-400 hover:text-white transition-colors py-2 px-3 md:px-0 relative z-50">Ecosystem</a>
           <a href="#impact" className="text-xs md:text-sm font-medium text-gray-400 hover:text-white transition-colors py-2 px-3 md:px-0 relative z-50">Impact</a>
           {user ? (
             <Link to="/dashboard" className="btn-premium btn-premium-primary text-xs !py-3 !px-4 md:!py-2 md:!px-6 min-h-[44px] relative z-50">Open Dashboard</Link>
           ) : (
             <div className="flex items-center gap-2 md:gap-4 relative z-50">
                <Link to="/login" className="text-xs md:text-sm font-bold hover:text-purple-400 transition-colors py-2 px-3 md:px-0 min-h-[44px] relative z-50">Sign In</Link>
                <Link to="/register" className="btn-premium btn-premium-primary text-xs !py-3 !px-4 md:!py-2 md:!px-6 min-h-[44px] relative z-50">Get Clearance</Link>
             </div>
           )}
        </div>
      </nav>
